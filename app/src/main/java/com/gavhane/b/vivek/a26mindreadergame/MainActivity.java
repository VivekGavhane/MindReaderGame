package com.gavhane.b.vivek.a26mindreadergame;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tv_info.setText("Think of a number between 1 to 1000 and I will guess it in 10 moves");
    ...
    private void guess(){
        mid = (left + right) /2;                        //as it is an int it will take integer number always
        tries++;
